...
class UR5Sim():
    ...
    def add_gui_sliders(self):
        self.sliders = []
        self.sliders.append(pybullet.addUserDebugParameter("X", -0.4, 0.4, 0))
        
        self.sliders.append(pybullet.addUserDebugParameter("Y", -0.4, 0.4, 0))
        self.sliders.append(pybullet.addUserDebugParameter("Z", -0.4, 0.4, 0))
